...
<head>
    ...
    <title>Crear Contraseña - SOMICAN</title>
...
<body> <!-- Explicado en accesoSocios.php -->
    <main>
        <div class="login-container background-2"> <!-- Lo único es que este <div> tiene otra clase para que el fondo sea distinto -->
            <h1>Crear contraseña</h1>
            <p>Crear contraseña de socio de Somican</p>
            <form method="POST" action="../PHPScripts/createPassword.php"> <!-- Y el formulario te lleva a createPassword.php -->
